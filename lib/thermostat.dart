// lib/thermostat.dart
import 'sensor_interfaces.dart'; // <--- Asegúrate que coincida el nombre (con 's' al final)
...
class Thermostat {
  ...
  // Unit to test: adjusts temperature and returns status message
  String setTargetTemperature(double newTemp) {
    if (newTemp < 15.0) {
      _targetTemperature = 15.0;
      return 'WARNING: Temperature too low. Maintained at 15.0°C.';
    } 
    if (newTemp > 30.0) {
